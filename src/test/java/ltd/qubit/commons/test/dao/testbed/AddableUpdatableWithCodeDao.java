 ...
 * @author 胡海星
 */
public interface AddableUpdatableWithCodeDao<T extends Identifiable & WithCode>
    extends AddableDao<T>, UpdatableWithCodeDao<T> {
  ...
  @Unmodified({"id", "code", "app", "ownerType", "ownerId", "username",
      ...
      "deleter", "deleteTime"})
  Instant addOrUpdateByCode(T entity) throws DataAccessException;
